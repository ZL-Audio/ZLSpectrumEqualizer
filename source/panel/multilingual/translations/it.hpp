...
namespace zlpanel::multilingual::it {
    static constexpr std::array kTexts = {
        ...
        "Premi: attiva il comportamento dinamico spettrale.",
        "Clicca: disattiva la banda.",

        "Rilascia: bypassa l'elaborazione dinamica spettrale.",
        "Premi: emetti il segnale delta dinamico spettrale.",
        "Scegli la modalità dinamica spettrale.",
